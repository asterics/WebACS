...
QUnit.test( "Model getFreePosition", function( assert ) {
	...
	assert.strictEqual(model.getFreePosition([1, 2])[0], 1 + mConst.MODEL_COMPONENTPOSITIONOFFSETX);
	assert.strictEqual(model.getFreePosition([1, 2])[1], 2 + mConst.MODEL_COMPONENTPOSITIONOFFSETY);
});
...
QUnit.test( "Model initiateComponentByName", function( assert ) {
	...
	assert.strictEqual(comp.getX(), mConst.MODEL_NEWCOMPONENTPOSITIONX);
	assert.strictEqual(comp.getY(), mConst.MODEL_NEWCOMPONENTPOSITIONY);
