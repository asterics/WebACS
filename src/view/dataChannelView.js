...
// ***********************************************************************************************************************
	var selectLine = function() {
		returnObj.line.stroke(vConst.DATACHANNELVIEW_SELECTEDSTROKECOLOR);
	...
	var componentPositionChangedEventHandlerInPort = function() {
		returnObj.line.points([	returnObj.line.points()[0], 
								...
								inputPort.getParentComponent().getX() - vConst.DATACHANNELVIEW_INPUTPORTLEFTOFCOMPONENT,
								inputPort.getParentComponent().getY() + vConst.DATACHANNELVIEW_FIRSTINPUTPORTDOCKINGPOINTY + vConst.COMPONENTVIEW_PORTHEIGHTPLUSGAP * inputPort.getPosition()]);
	...
	var componentPositionChangedEventHandlerOutPort = function() {
		returnObj.line.points([	outputPort.getParentComponent().getX() + vConst.DATACHANNELVIEW_OUTPUTPORTPOSITIONX, 
								outputPort.getParentComponent().getY() + vConst.DATACHANNELVIEW_FIRSTOUTPUTPORTDOCKINGPOINTY + vConst.COMPONENTVIEW_PORTHEIGHTPLUSGAP * outputPort.getPosition(), 
	...
	var deSelectedEventHandler = function() {
		returnObj.line.stroke(vConst.DATACHANNELVIEW_STROKECOLOR);
...
// ***********************************************************************************************************************
	if (inputPort) { // i.e. channel is already complete
		...
		returnObj.line.points([	outputPort.getParentComponent().getX() + vConst.DATACHANNELVIEW_OUTPUTPORTPOSITIONX, 
								outputPort.getParentComponent().getY() + vConst.DATACHANNELVIEW_FIRSTOUTPUTPORTDOCKINGPOINTY + vConst.COMPONENTVIEW_PORTHEIGHTPLUSGAP * outputPort.getPosition(), 
								outputPort.getParentComponent().getX() + vConst.DATACHANNELVIEW_OUTPUTPORTPOSITIONX, 
								outputPort.getParentComponent().getY() + vConst.DATACHANNELVIEW_FIRSTOUTPUTPORTDOCKINGPOINTY + vConst.COMPONENTVIEW_PORTHEIGHTPLUSGAP * outputPort.getPosition()]);
	}
