 ...
 */
 ...
 import EditorProperties from "./editorProperties.js";
...
// ************************************************** private variables **************************************************
// ***********************************************************************************************************************
	var canvasTabPanel = TabPanel(vConst.CANVASVIEW_MOTHERPANEL, vConst.CANVASVIEW_CLASSOFTAB, vConst.CANVASVIEW_CLASSOFPANEL);
...
// ***********************************************************************************************************************
	...
	var removingModelEventHandler = function() {
		...
		document.getElementById(vConst.CANVASVIEW_TABLIST).removeChild(document.getElementById(removePanel.replace('Panel', 'Tab')));
		document.getElementById(vConst.CANVASVIEW_MOTHERPANEL).removeChild(document.getElementById(removePanel));
		// update the tabPanel:
		canvasTabPanel.updatePanel();
	}
	
	var tabSwitchedEventHandler = function() {
		var elements = document.getElementById(vConst.CANVASVIEW_TABLIST).getElementsByClassName('tab');
...
// ***********************************************************************************************************************
	...
	returnObj.addActModelToView = function() {
		...
		document.getElementById(vConst.CANVASVIEW_TABLIST).appendChild(li);
		...
		modelViewList.push(ModelView('canvasPanel' + panelId, actModel, clipBoard, editorProperties));
		panelId++;
		canvasTabPanel.updatePanel();
