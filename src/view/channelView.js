...
// ***********************************************************************************************************************
	returnObj.line = new Kinetic.Line({
		points: [0, 0, 0, 0],
		stroke: vConst.CHANNELVIEW_STROKECOLOR,
		strokeWidth: vConst.CHANNELVIEW_STROKEWIDTH,
		dash: [5, 5],
		dashEnabled: false,
		...
		hitFunc: function(context) {
			...
			this.setStrokeWidth(vConst.CHANNELVIEW_HITREGIONWIDTH);
			context.fillStrokeShape(this);
			this.setStrokeWidth(vConst.CHANNELVIEW_STROKEWIDTH);
		}
	});
