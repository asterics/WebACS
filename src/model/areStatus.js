 ...
 */
 ...
 import { downloadDeployedModel } from "../are/rest/areCommunicator.js";
...
// ************************************************** private variables **************************************************
// ***********************************************************************************************************************
	var status = statusType.DISCONNECTED;
...
// ***********************************************************************************************************************
	...
	returnObj.checkAndSetSynchronisation = function() {
		if ((typeof modelList != 'undefined') && (status != statusType.DISCONNECTED) && (status != statusType.CONNECTIONLOST) && (status != statusType.CONNECTING)) {
	...
	returnObj.setStatus = function(newStatus) { // statusType
		status = newStatus;
	...
	returnObj.getStatus = function() {
     ...
     returnObj.isConnected = function() {
         return status && status != statusType.CONNECTING && status != statusType.CONNECTIONLOST && status != statusType.DISCONNECTED;
     }
